...
var InputFilterComponent = (function (_super) {
    ...
    InputFilterComponent.prototype.ngOnInit = function () {
        ...
        this.inputControl.valueChanges
			...
			_this.inputControl.setValue(value);
			return _this.setFilter(); 
			
			});
    };
	
	InputFilterComponent.prototype.inputTextChanged = function (event) {
		if(this.query.year!==undefined) {
        //this.query = this.query.year+'-'+this.query.month+'-'+this.query.day;
...
InputFilterComponent = __decorate([
    Component({
        ...
        template: "\n    <input ngbDatepicker #d=\"ngbDatepicker\" (click)=\"d.toggle()\"   [(ngModel)]=\"query\"\n  \n  [ngClass]=\"inputClass\"\n           [formControl]=\"inputControl\"\n           class=\"form-control\"\n           type=\"text\"\n           placeholder=\"{{ column.title }}\" />\n  ",
    }),
